...
<head>
    ...
    <link rel="apple-touch-icon" sizes="120x120"
        href="{{ asset('nptl-admin/img/splash/touch-icon-iphone-retina.png') }}">
    <link rel="apple-touch-icon" sizes="152x152"
        href="{{ asset('nptl-admin/img/splash/touch-icon-ipad-retina.png') }}">
...
<body class="smart-style-1">
    ...
    <header id="header">
        ...
        <?php
        $pending_orders = \App\Model\Common\Order::latest()->take('5')->get();
        $new_users = \App\User::latest()->take('5')->get();
        $products_low_qty = \App\Model\Common\Product::where('product_qty', '<', 2)->take('5')->get();
        ?>
                            ...
                            <div class="slimScrollDiv">
                                <ul class="menu">
                                    @forelse($pending_orders as $order)
                                        <li>
                                            <a target="_blank"
                                                href="{{ url(config('constant.smAdminSlug') . '/orders/' . $order->id) }}?isAdmin=1">
                                                <div class="pull-left">
                                                    @if ($order->user)
                                                    ...
                                                    @else
                                                        <img src="{{ asset('images/default-user.png') }}"
                                                            class="img-circle" alt="No User">
                                                    @endif
                                                </div>
                                                <h4>
                                                    {{ $order->user ? $order->user->firstname : 'Unknown User' }}
                                                    <small>
                                ...
                                <ul class="menu">
                                    @forelse($new_users as $new_user)
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{!! SM::sm_get_the_src($new_user->image, 30, 30) !!}" class="img-circle">
                                                </div>
                                                <h4>
                                                    {{ $new_user->firstname }}
                                                    <small><i class="fa fa-clock-o"></i>
                                                        {{ SM::showDateTime($new_user->created_at) }}</small>
                                                </h4>
                                                <p></p>
                                            </a>
                                        </li>
                                    ...
                                    @forelse($products_low_qty as $low_qty)
                                        <li>
                                            <a target="_blank" href="#">
                                                <div class="pull-left">
                                                    <img src="{!! SM::sm_get_the_src($low_qty->image, 30, 30) !!}" class="img-circle"
                                                        alt="{{ $low_qty->title }}">
                                                </div>
                                                <h4>
                                                    <small>
        ...
        <div class="pull-right">
            ...
            <div id="" class="btn-header pull-right">
                <span> <a href="{{ url('') }}" title="View site" target="_blank"><i
            ...
            <div class="col-xs-12">
                <p class="txt-color-white text-center">&copy; <?php echo date('Y'); ?> by
                    ...
                    rights reserved. Design and Developed By <i class="fa fa-heart"></i> By <a
                        href="https://nextpagetl.com">Next Page Technology Ltd.</a>
                </p>
            </div>
