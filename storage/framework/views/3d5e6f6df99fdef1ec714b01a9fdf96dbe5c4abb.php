<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/lib/bootstrap/css/bootstrap.min.css')); ?>"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('frontend/lib/font-awesome/css/font-awesome.min.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/lib/select2/css/select2.min.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/lib/jquery.bxslider/jquery.bxslider.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/lib/owl.carousel/owl.carousel.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/lib/jquery-ui/jquery-ui.css')); ?>"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/css/option5.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/css/custom.css')); ?>"/>
    
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/dashboard/dashboard.css')); ?>"/>
